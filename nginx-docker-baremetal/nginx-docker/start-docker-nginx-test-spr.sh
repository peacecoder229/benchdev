...
numactl --membind=1 --physcpubind=48 ./wrk/wrk -t 1 -c 32 -d 300s -L http://127.0.0.1:80/1K
...
numactl --membind=1 --physcpubind=48-51 ./wrk/wrk -t 4 -c 256 -d 300s -L http://127.0.0.1:80/1K
