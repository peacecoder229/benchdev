...
def mbox_busy():
    ...
    while True:
        ...
        mbox_is_busy=((int(mboxif,16) & const.MBOX_INTERFACE_RUN_BUSY) == const.MBOX_INTERFACE_RUN_BUSY)
...
def mbox_read_data_interface():
    ...
    print "OSmailbox data",commands.getoutput("rdmsr ""-p 1 "+const.MSR_OS_MAILBOX_DATA)
    print "OSMailbox interface",commands.getoutput("rdmsr ""-p 1 "+const.MSR_OS_MAILBOX_INTERFACE)
