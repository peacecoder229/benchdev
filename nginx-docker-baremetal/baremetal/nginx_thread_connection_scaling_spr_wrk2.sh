...
#numactl --membind=1 --physcpubind=48 ./wrk2/wrk -t 1 -c 140 -d 300s -L http://127.0.0.1:9090/1K
...
numactl --membind=1 --physcpubind=48-51 ./wrk2/wrk -t 8 -c 2000 -R 256000 -d 300s -L http://127.0.0.1:9090/1K

source start-nginx.sh 0-7 9090
P1=$!
wait $P1
#numactl --membind=1 --physcpubind=48-55 ./wrk/wrk -t 8 -c 224 -d 300s -L http://127.0.0.1:9090/1kb.bin
numactl --membind=1 --physcpubind=48-55 ./wrk2/wrk -t 16 -c 4000 -R 512000 -d 300s -L http://127.0.0.1:9090/1K

source start-nginx.sh 0-15 9090
P1=$!
wait $P1
#numactl --membind=1 --physcpubind=48-63 ./wrk/wrk -t 16 -c  -d 336s -L http://127.0.0.1:9090/1kb.bin
numactl --membind=1 --physcpubind=48-63 ./wrk2/wrk -t 32 -c 8000 -R 1024000 -d 300s -L http://127.0.0.1:9090/1K
...
numactl --membind=1 --physcpubind=48-79 ./wrk2/wrk -t 64 -c 16000 -R 2048000 -d 300s -L http://127.0.0.1:9090/1K
...
#numactl --membind=1 --physcpubind=48-95 ./wrk2/wrk -t 48 -c 32000 -d 300s -L http://127.0.0.1:9090/1K
